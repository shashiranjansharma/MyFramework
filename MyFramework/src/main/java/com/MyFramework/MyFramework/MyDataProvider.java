...
public class MyDataProvider {
	...
	public static Object[][] launchData(){
		Object[][] searchTerms = new Object[3][1];
		searchTerms[0][0] = "What is the difference bitween native and hybrid app?";
		searchTerms[1][0] = "What is hybrid app?";
		searchTerms[2][0] = "What is native app?";
		return searchTerms;
	}
}
